...
void inicializaPontosCubo(){
  ...
  pontoCubo[0].x=0;pontoCubo[0].y=0;pontoCubo[0].z=-0.20;           //b4
  pontoCubo[1].x=0;pontoCubo[1].y=0.20f;pontoCubo[1].z=-0.20f;      //t4
  pontoCubo[2].x=0;pontoCubo[2].y=0.20f;pontoCubo[2].z=-0.60f;      //t1
  pontoCubo[3].x=0;pontoCubo[3].y=0;pontoCubo[3].z=-0.60f;          //b1
  pontoCubo[4].x=0.30f;pontoCubo[4].y=0;pontoCubo[4].z=-0.60f;      //b2
  pontoCubo[5].x=0.30f;pontoCubo[5].y=0.20f;pontoCubo[5].z=-0.60f;  //t2
  pontoCubo[6].x=0.30f;pontoCubo[6].y=0.20f;pontoCubo[6].z=-0.20;   //t3
  pontoCubo[7].x=0.30f;pontoCubo[7].y=0;pontoCubo[7].z=-0.20;       //b3
